...
return {
  ...
  },
  {
    ...
    keys = {
      ...
      { '<leader>w2',          function() require 'bufferjump'.ix(1) end,                               mode = { 'n', 'v', }, silent = true,  desc = 'fix win back size 1', },
      { '<leader>w3',          function() require 'bufferjump'.ix(2) end,                               mode = { 'n', 'v', }, silent = true,  desc = 'fix win back size 2', },
      { '<leader>w4',          function() require 'bufferjump'.ix(3) end,                               mode = { 'n', 'v', }, silent = true,  desc = 'fix win back size 3', },
      { '<leader>w5',          function() require 'bufferjump'.ix(4) end,                               mode = { 'n', 'v', }, silent = true,  desc = 'fix win back size 4', },
      { '<leader>w6',          function() require 'bufferjump'.ix(5) end,                               mode = { 'n', 'v', }, silent = true,  desc = 'fix win back size 5', },
      { '<leader>w7',          function() require 'bufferjump'.ix(6) end,                               mode = { 'n', 'v', }, silent = true,  desc = 'fix win back size 6', },
      ...
      { '<leader>xvp',         function() require 'buffernew'.projbwipeout() end,                       mode = { 'n', 'v', }, silent = true,  desc = 'tabbwipeout', },
