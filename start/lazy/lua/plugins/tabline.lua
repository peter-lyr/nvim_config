...
return {
  ...
  keys = {
    ...
    { '<c-q><c-w>',  function() require 'tabline'.only_cur_buffer() end,                 mode = { 'n', 'v', }, silent = true, desc = 'tabline only cur buffer', },
    { '<c-q>w',      function() require 'tabline'.only_cur_buffer() end,                 mode = { 'n', 'v', }, silent = true, desc = 'tabline only cur buffer', },
    ...
    { '<c-q><c-m>',  function() require 'tabline'.append_one_proj_new_tab_no_dupl() end, mode = { 'n', 'v', }, silent = true, desc = 'tabline append one proj new tab no dupl', },
    { '<c-q>m',      function() require 'tabline'.append_one_proj_new_tab_no_dupl() end, mode = { 'n', 'v', }, silent = true, desc = 'tabline append one proj new tab no dupl', },
    { '<c-q><c-bs>', function() require 'tabline'.simple_statusline_toggle() end,        mode = { 'n', 'v', }, silent = true, desc = 'tabline simple statusline toggle', },
