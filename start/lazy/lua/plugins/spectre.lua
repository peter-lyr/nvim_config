return {
  ...
  keys = {
    ...
    { '<leader>rp', function() require 'spectre'.open_file_search { select_word = true, } end, mode = { 'n', 'v', }, silent = true, desc = 'Search on current file', },
  },
  dependencies = {
    require 'plugins.whichkey',
  },
  init = function()
    require 'which-key'.register { ['<leader>r'] = { name = 'Spectre', }, }
  end,
  config = function()
