...
return {
  ...
  keys = {
    ...
    { '<leader><f1> ',    function() require 'terminal'.hideall() end,                               mode = { 'n', 'v', }, silent = true, desc = 'terminal hide all', },
    { '<leader><f2> ',    function() require 'terminal'.hideall() end,                               mode = { 'n', 'v', }, silent = true, desc = 'terminal hide all', },
    { '<leader><f3> ',    function() require 'terminal'.hideall() end,                               mode = { 'n', 'v', }, silent = true, desc = 'terminal hide all', },
    { '<leader><f4> ',    function() require 'terminal'.hideall() end,                               mode = { 'n', 'v', }, silent = true, desc = 'terminal hide all', },
