return {
  ...
  keys = {
    ...
    { '[f',          vim.diagnostic.open_float,                                   mode = { 'n', 'v', }, silent = true, desc = 'lsp vim.diagnostic.open_float', },
    { ']f',          vim.diagnostic.setloclist,                                   mode = { 'n', 'v', }, silent = true, desc = 'lsp vim.diagnostic.setloclist', },
    { '[d',          vim.diagnostic.goto_prev,                                    mode = { 'n', 'v', }, silent = true, desc = 'lsp vim.diagnostic.goto_prev', },
    ...
    { 'K',           vim.lsp.buf.definition,                                      mode = { 'n', 'v', }, silent = true, desc = 'lsp vim.lsp.buf.definition', },
    ...
    { '<C-F12>',     vim.lsp.buf.declaration,                                     mode = { 'n', 'v', }, silent = true, desc = 'lsp vim.lsp.buf.declaration', },
    { '<leader>fh',  vim.lsp.buf.hover,                                           mode = { 'n', 'v', }, silent = true, desc = 'lsp vim.lsp.buf.hover', },
    { '<A-F12>',     vim.lsp.buf.hover,                                           mode = { 'n', 'v', }, silent = true, desc = 'lsp vim.lsp.buf.hover', },
    { '<leader>fi',  vim.lsp.buf.implementation,                                  mode = { 'n', 'v', }, silent = true, desc = 'lsp vim.lsp.buf.implementation', },
    { '<leader>fs',  vim.lsp.buf.signature_help,                                  mode = { 'n', 'v', }, silent = true, desc = 'lsp vim.lsp.buf.signature_help', },
    { '<leader>fe',  vim.lsp.buf.references,                                      mode = { 'n', 'v', }, silent = true, desc = 'lsp vim.lsp.buf.references', },
    { '<S-F12>',     vim.lsp.buf.references,                                      mode = { 'n', 'v', }, silent = true, desc = 'lsp vim.lsp.buf.references', },
    { '<leader>fvd', vim.lsp.buf.type_definition,                                 mode = { 'n', 'v', }, silent = true, desc = 'lsp vim.lsp.buf.type_definition', },
    { '<leader>fc',  vim.lsp.buf.code_action,                                     mode = { 'n', 'v', }, silent = true, desc = 'lsp vim.lsp.buf.code_action', },
