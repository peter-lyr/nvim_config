...
try:
  ...
  os.system(
    ...
    + os.path.join(absdir, "markdown_export.lua.requirements.txt")
  )
  import base64
...
CSS_PATH = os.path.join(absdir, "markdown_export.lua.hl.css")
...
css_p = CSS_PATH
css2_p = os.path.join(absdir, "markdown_export.lua.extra.css")
js_p = os.path.join(absdir, "markdown_export.lua.rd.js")
...
if __name__ == "__main__":
  try:
    ...
    md_p = os.path.join(absdir, "markdown_export.lua.a.md")
    print(md_p)
  main(md_p)
