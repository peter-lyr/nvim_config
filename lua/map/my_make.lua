...
vim.keymap.set({ 'n', 'v', }, '<leader>bc<c-m>', function() require 'config.my_make'.remake() end, M.opt 'remake')
vim.keymap.set({ 'n', 'v', }, '<leader>bc<c-s-m>', function() require 'config.my_make'.remake 'start' end, M.opt 'remake start')
