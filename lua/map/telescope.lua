...
vim.keymap.set({ 'n', 'v', }, '<leader>s<a-l>', function() require 'config.telescope'.live_grep_rg() end, M.opt 'live_grep_rg')
vim.keymap.set({ 'n', 'v', }, '<leader>s<a-s-l>', function() require 'config.telescope'.live_grep_rg_all() end, M.opt 'live_grep_rg_all')
vim.keymap.set({ 'n', 'v', }, '<leader>s<leader>', function() require 'config.telescope'.find_files() end, M.opt 'find_files')
vim.keymap.set({ 'n', 'v', }, '<leader>s<c-l>', function() require 'config.telescope'.live_grep_def() end, M.opt 'live_grep_def')
vim.keymap.set({ 'n', 'v', }, '<leader>s<c-s-l>', function() require 'config.telescope'.live_grep_def_all() end, M.opt 'live_grep_def_all')
