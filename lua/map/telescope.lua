...
vim.keymap.set({ 'n', 'v', }, '<leader>sf<leader>', function() require 'config.telescope'.find_files(1) end, M.opt 'find_files root')
vim.keymap.set({ 'n', 'v', }, '<leader>sfv<leader>', function() require 'config.telescope'.find_files_all(1) end, M.opt 'find_files_all root')

vim.keymap.set({ 'n', 'v', }, '<leader>sl', function() require 'config.telescope'.live_grep() end, M.opt 'live_grep')
vim.keymap.set({ 'n', 'v', }, '<leader>sL', function() require 'config.telescope'.live_grep_all() end, M.opt 'live_grep_all')

vim.keymap.set({ 'n', 'v', }, '<leader>s<c-l>', function() require 'config.telescope'.live_grep_rg() end, M.opt 'live_grep_rg')
vim.keymap.set({ 'n', 'v', }, '<leader>s<a-l>', function() require 'config.telescope'.live_grep_rg_all() end, M.opt 'live_grep_rg_all')
...
vim.keymap.set({ 'n', 'v', }, '<leader>sft', function() require 'config.telescope'.filetypes() end, M.opt 'filetypes')
...
B.register_whichkey('config.telescope', '<leader>sf', 'files or filetypes')
B.register_whichkey('config.telescope', '<leader>sfv', 'files root')
